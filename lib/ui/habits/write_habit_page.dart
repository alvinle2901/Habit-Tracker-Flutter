...
import 'package:habit_tracker/ui/components/app_back_button.dart';
import 'package:habit_tracker/ui/components/custom_scaffold.dart';
import 'package:habit_tracker/ui/components/loading_layer.dart';
import 'package:habit_tracker/ui/components/status_button.dart';
import 'package:habit_tracker/ui/habits/providers/write_habit_view_model_provider.dart';
import 'package:habit_tracker/ui/habits/widgets/custom_switch.dart';
import 'package:habit_tracker/utils/assets.dart';
import 'package:habit_tracker/utils/formats.dart';
import 'package:habit_tracker/utils/labels.dart';
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  final count =
                                      model.initial.frequency[e.labelDay] ?? 0;
                                  return Expanded(
                                    child: Column(
                                      children: [
                                        Text(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              CupertinoButton(
                                child: Row(
                                  children: [
                                    Text(model.initial.reminders.length
                                        .toString()),
                                    Icon(Icons.keyboard_arrow_right_rounded)
                                  ],
                                ),
